...
inline uint8_t ArcGraphics_GetMajorVersion( void )
{
	return ARC_GRAPHICS_MAJOR_VERSION;
}

inline uint8_t ArcGraphics_GetMinorVersion( void )
{
	return ARC_GRAPHICS_MINOR_VERSION;
}

inline uint8_t ArcGraphics_GetPatchVersion( void )
{
...
inline bool ArcGraphics_AboveVersion( uint8_t major, uint8_t minor, uint8_t patch )
{
