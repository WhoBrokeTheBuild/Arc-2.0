...
inline uint8_t ArcNet_GetMajorVersion( void )
{
	return ARC_NET_MAJOR_VERSION;
}

inline uint8_t ArcNet_GetMinorVersion( void )
{
	return ARC_NET_MINOR_VERSION;
}

inline uint8_t ArcNet_GetPatchVersion( void )
{
...
inline bool ArcNet_AboveVersion( uint8_t major, uint8_t minor, uint8_t patch )
{
